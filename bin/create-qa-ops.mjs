...
function main() {
  ...
  log('');
  log(`${BOLD}create-qa-ops${RESET} ${DIM}v1.0.0${RESET}`);
  ...
  log(`  1. Read ${CYAN}docs/quality/review-sop.md${RESET} for the operating procedure`);
  log(`  2. Adapt prompt templates in ${CYAN}docs/quality/templates/${RESET}`);
