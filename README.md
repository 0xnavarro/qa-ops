...
2. Read `docs/quality/review-sop.md` for the full operating procedure
3. Adapt the prompt templates in `docs/quality/templates/` — replace `{{PLACEHOLDERS}}` with your project values
